        ...
        <div className='flex flex-col h-auto' style={{ height: "88%" }}>
            ...
            <div className="flex justify-center items-center">
                <div className="m-4 flex items-end flex-nowrap bg-white rounded-[40px] min-h-max w-8/12 min-h-14 px-3 py-2 mb-8">
                    ...
                    <textarea autoFocus placeholder="Quote" rows="1" id="search" onChange={(e) => setSearchText(e.target.value)} value={searchText} className='grow overflow-y m-w max-h-44 w-full border-none text-gray-800/95 text-2xl font-medium focus:outline-0 focus:ring-0 '></textarea>
