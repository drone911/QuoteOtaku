...
export default function Main({ openSidebar, closeSidebar, showSidebar, activeSearch }) {
    ...
    return (
        <React.Fragment>
            <div id="header" className="flex w-100 justify-between items-center justify-center" style={{ height: "12%" }}>
                <button type="button" onClick={showSidebar ? closeSidebar : openSidebar} className='hover:bg-gray-600/45 focus:bg-gray-600/45 shadow-lg rounded-full m-4'>
                    {showSidebar && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} className="m-1 color-[#e700ff] size-14 stroke-gray-200 pr-2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75 14.25 12m0 0 2.25 2.25M14.25 12l2.25-2.25M14.25 12 12 14.25m-2.58 4.92-6.374-6.375a1.125 1.125 0 0 1 0-1.59L9.42 4.83c.21-.211.497-.33.795-.33H19.5a2.25 2.25 0 0 1 2.25 2.25v10.5a2.25 2.25 0 0 1-2.25 2.25h-9.284c-.298 0-.585-.119-.795-.33Z" />
                    </svg>
                    }
                    {!showSidebar && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} className="m-1 color-[#e700ff] size-14 stroke-gray-200">
                ...
                <button className='hover:bg-gray-600/45 focus:bg-gray-600/45 shadow-lg rounded-full m-4'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} className="m-1 color-[#e700ff] size-14 stroke-gray-200">
